...
MYBATIS =   { 
	:core => "org.mybatis:mybatis:jar:3.0.1",
	:sqlmap => "org.apache.ibatis:ibatis-sqlmap:jar:2.3.4.726",
	:spring => "org.mybatis:mybatis-spring:jar:1.0.2"
}

SOJO = "net.sf.sojo:sojo:jar:1.0.0"
...
POSTGRES = "postgresql:postgresql:jar:9.0-801.jdbc4"
...
SPRING = {
  :core => "org.springframework:spring-core:jar:2.5.6",
  :spring_json => "net.sf.spring-json:spring-json:jar:1.3.1",
  :webmvc => "org.springframework:spring-webmvc:jar:2.5.6",
  :web => "org.springframework:spring-web:jar:2.5.6",
  :all => "org.springframework:spring:jar:2.5.6",
  :context => "org.springframework:spring-context:jar:2.5.6"
}
SPRING_MOCK = [
